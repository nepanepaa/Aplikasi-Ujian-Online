...
$config['versi']                = "1.0";           //isi sesuai kebutuhan nama pada header
...
$config['nama_sekolah']         = "SMA"; //isi sesuai kebutuhan nama sekolah
$config['nama_ujian']           = "PAT GENAP - 2020/2021"; //isi sesuai kebutuhan jenis ujian
$config['nama_kepala']          = "Dimas"; //isi sesuai nama kepala
$config['nip_kepala']           = "21066"; //isi sesuai nama kepala
